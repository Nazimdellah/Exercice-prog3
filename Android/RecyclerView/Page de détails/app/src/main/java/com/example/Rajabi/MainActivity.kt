...
class MainActivity : AppCompatActivity() {
    ...
    private fun fillRecycler() {
        val items: MutableList<Album> = mutableListOf(
            Album(1, "Album 1", "Artist A"),
            Album(2, "Album 2", "Artist B"),
            Album(3, "Album 3", "Artist C"),
            Album(4, "Album 4", "Artist D"),
            Album(5, "Album 5", "Artist E"),
            //generate more items here
            Album(6, "Album 6", "Artist F"),
            Album(7, "Album 7", "Artist G"),
            Album(8, "Album 8", "Artist H"),
            Album(9, "Album 9", "Artist I"),
            Album(10, "Album 10", "Artist J"),
